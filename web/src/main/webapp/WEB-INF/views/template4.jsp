...
<head>
    ...
    <link href="${contextPath}/css/mdb4free/mdb-admin.css" rel="stylesheet">
    ...
    <link href="${contextPath}/css/mdb4free/style.css" rel="stylesheet">

    <!-- JQuery -->
    <script type="text/javascript" src="${contextPath}/js/mdb4free/jquery-2.2.3.min.js"></script>

    <meta name="google-site-verification" content="YaH6bzq4dS8k8crjcyDzneioxra-79rpVHVamO7UnWg"/>
</head>

<body id="boxed-bg" class="boxed light-blue-skin" >
...
<script type="text/javascript" src="${contextPath}/js/mdb4free/popper.min.js"></script>
<script type="text/javascript" src="${contextPath}/js/mdb4free/tether.min.js"></script>
...
<script type="text/javascript" src="${contextPath}/js/mdb4free/main.js"></script>
