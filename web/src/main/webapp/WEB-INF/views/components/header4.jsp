...
<sec:authorize access="hasRole('ROLE_COMPANY')">
    <c:if test="${company.currentTariff.dead}">
        <div class="flex-center danger-color-dark">
            <p class="white-text my-1">Доступ к системе ограничен.</p>
        </div>
    </c:if>

    <c:if test="${company.currentTariff.endingInLessThanThreeDays}">
        <div class="flex-center warning-color-dark">
            <p class="white-text my-1">До окончания тарифа осталось менее 3-х дней</p>
        </div>
    </c:if>
</sec:authorize>
    ...
    <div class="container-fluid">
        ...
        <sec:authorize access="isAnonymous()">
            <ul class="nav navbar-nav float-xs-right">
                    ...
                    <%--<li class="nav-item">--%>
                    <%--<a href="${contextPath}/registration-company" style="margin-right: 10px"--%>
                    <%--onclick="goog_report_conversion ('${contextPath}/registration-company')">--%>
                    <%--<i class="fa fa-sign-in"></i> Регистрация компании </a>--%>
                    <%--</li>--%>
                <li class="nav-item">
                    <a href="${contextPath}/login"><i class="fa fa-lock after"></i> Вход для пользователей </a>
                </li>
            </ul>
        </sec:authorize>
        ...
        <sec:authorize access="isAuthenticated()">
            <sec:authorize access="hasRole('ROLE_COMPANY')">
                <a class="navbar-brand" href="${contextPath}/company/profile">${company.name}</a>
            </sec:authorize>
            <sec:authorize access="hasRole('ROLE_USER')">
                <a class="navbar-brand" href="${contextPath}/account">${currentUser.name} ${currentUser.lastName}
                    <span class="label label-primary">${currentCard.cardUUID}</span></a>


                <%--TODO DV isChangedInitPassword--%>
            ...
            <sec:authorize access="hasRole('ROLE_ADMIN')">
                <a class="navbar-brand"
                   href="${contextPath}/account">Администратор ${currentUser.name} ${currentUser.lastName}</a>
            </sec:authorize>

            <button class="navbar-toggler hidden-sm-up" type="button" data-toggle="collapse" data-target="#collapseEx1">
                <i class="fa fa-bars"></i>
            </button>

            <div class="collapse navbar-toggleable-xs" id="collapseEx1">
                <ul class="nav navbar-nav float-xs-right">
                    <sec:authorize access="hasRole('ROLE_COMPANY')">
                        <li class="nav-item">
                            <a class="nav-link" href="${contextPath}/company/profile">Профиль компании</a></li>
                        <li class="nav-item">
                            <a class="nav-link" href="${contextPath}/company/settings/product">Настройки</a></li>
                    </sec:authorize>
                    <li class="nav-item">
                        <a class="nav-link" href="${contextPath}/account">Аккаунт</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="${contextPath}/j_spring_security_logout">Выйти</a>
                    </li>
                </ul>
            </div>
...
<%--&lt;%&ndash;<li><a class="waves-effect waves-light" href="${contextPath}/registration">Зарегистрироваться&ndash;%&gt;--%>
<%--&lt;%&ndash;<i class="fa fa-lock after"></i></a></li>&ndash;%&gt;--%>
<%--<li><a class="waves-effect waves-light" href="${contextPath}/registration-company"--%>
<%--onclick="goog_report_conversion ('${contextPath}/registration-company')">--%>
<%--Зарегистрировать свою компанию--%>
<%--&lt;%&ndash;<i class="fa fa- after"></i>&ndash;%&gt;--%>
<%--</a></li>--%>
...
<%--<ul class="nav navbar-right navbar-nav">--%>
<%--&lt;%&ndash;<sec:authorize access="hasRole('ROLE_SYSTEM')">&ndash;%&gt;--%>
<%--&lt;%&ndash;<li><a href="${contextPath}/system">СИСТЕМ</a></li>&ndash;%&gt;--%>
<%--&lt;%&ndash;</sec:authorize>&ndash;%&gt;--%>
<%--&lt;%&ndash;<sec:authorize access="hasRole('ROLE_USER')">&ndash;%&gt;--%>
<%--&lt;%&ndash;<li><a class="waves-effect waves-light" href="${contextPath}/user/abonnements">Мои&ndash;%&gt;--%>
<%--&lt;%&ndash;абонементы</a></li>&ndash;%&gt;--%>
<%--&lt;%&ndash;</sec:authorize>&ndash;%&gt;--%>
<%--<sec:authorize access="hasRole('ROLE_COMPANY')">--%>
...
<nav class="navbar main-menu" style="margin-bottom: 20px">
    ...
    <div class="container-flued">
        ...
        <div class="collapse navbar-toggleable-xs" id="collapseEx2">
            ...
            <ul class="nav navbar-nav">
                <sec:authorize access="hasRole('ROLE_ADMIN')">
                    <li class="nav-item ${requestUri == '/' ? 'active' : ''}">
                        <a href="${contextPath}/"
                           class="btn btn-default waves-effect waves-light">Главная</a>
                    </li>
                    <li class="nav-item ${fn:startsWith(requestUri, '/admin/companies') ? 'active' : ''}">
                        <a href="${contextPath}/admin/companies" class="btn btn-default waves-effect waves-light">Компании</a>
                    </li>
                    <li class="nav-item ${fn:startsWith(requestUri, '/admin/cards') ? 'active' : ''}">
                        <a href="${contextPath}/admin/cards" class="btn btn-default waves-effect waves-light">Карты</a>
                    </li>
                    <li class="nav-item" ${fn:startsWith(requestScope['javax.servlet.forward.request_uri'], '/admin/users') ? 'class="active"' : ''}>
                        <a href="${contextPath}/admin/users" class="btn btn-default waves-effect waves-light">Пользователи</a>
                    </li>
                    <li class="nav-item" ${fn:startsWith(requestScope['javax.servlet.forward.request_uri'], '/admin/sms') ? 'class="active"' : ''}>
                        <a href="${contextPath}/admin/sms" class="btn btn-default waves-effect waves-light">SMS
                            рассылка</a></li>
                    <li class="nav-item" ${fn:startsWith(requestScope['javax.servlet.forward.request_uri'], '/admin/tariffs') ? 'class="active"' : ''}>
                        <a href="${contextPath}/admin/tariffs"
                           class="btn btn-default waves-effect waves-light">Тарифы</a></li>
                    <li class="nav-item" ${fn:startsWith(requestScope['javax.servlet.forward.request_uri'], '/admin/analytics') ? 'class="active"' : ''}>
                        <a href="${contextPath}/admin/analytics"
                           class="btn btn-default waves-effect waves-light">Аналитика</a></li>
                </sec:authorize>
                <sec:authorize access="hasRole('ROLE_COMPANY')">
                    <li class="nav-item ${requestUri == '/' ? 'active' : ''}">
                        <a href="${contextPath}/" class="btn btn-default waves-effect waves-light">Главная</a>
                    </li>
                    <li class="nav-item ${fn:startsWith(requestUri, '/company/products') ? 'active' : ''}">
                        <a href="${contextPath}/company/products" class="btn btn-default waves-effect waves-light">Абонементы</a>
                    </li>
                    <li class="nav-item ${fn:startsWith(requestUri, '/company/promotions') ? 'active' : ''}">
                        <a href="${contextPath}/company/promotions" class="btn btn-default waves-effect waves-light">Скидки</a>
                    </li>
                    <li class="nav-item ${fn:startsWith(requestUri, '/company/trainers') ? 'active' : ''}">
                        <a href="${contextPath}/company/trainers" class="btn btn-default waves-effect waves-light">Тренеры</a>
                    </li>
                    <li class="nav-item ${fn:startsWith(requestUri, '/company/cards') ? 'active' : ''}">
                        <a href="${contextPath}/company/cards"
                           class="btn btn-default waves-effect waves-light">Клиенты</a>
                    </li>
                    ...
                    <%--</ul>--%>
                    <%--</li>--%>
                    <li class="nav-item ${fn:startsWith(requestUri, '/company/reports') ? 'active' : ''}">
                        <a href="${contextPath}/company/reports/products"
                           class="btn btn-default waves-effect waves-light">Отчеты</a>
                    </li>
                    <li class="nav-item ${fn:startsWith(requestUri, '/company/balance') ? 'active' : ''}">
                        <a href="${contextPath}/company/balance"
                           class="btn btn-default waves-effect waves-light">Баланс</a>
                    </li>
                    <li class="nav-item ${fn:startsWith(requestUri, '/company/widget/design') ? 'active' : ''}">
                        <a href="${contextPath}/company/widget/design"
                           class="btn btn-default waves-effect waves-light">Онлайн-запись</a>
                    </li>
                </sec:authorize>
                <sec:authorize access="isAnonymous()">
                    <li class="nav-item ${requestUri == '/' ? 'active' : ''}">
                    ...
                    <li class="nav-item ${requestUri == '/features' ? 'active' : ''}">
                        <a href="${contextPath}/features" class="btn btn-default waves-effect waves-light">Решение</a>
                    </li>
                    <li class="nav-item ${requestUri == '/tariffs' ? 'active' : ''}">
                        <a href="${contextPath}/tariffs" class="btn btn-default waves-effect waves-light">Тарифы</a>
                    </li>
                    <li class="nav-item ${requestUri == '/about' ? 'active' : ''}">
                        <a href="${contextPath}/about" class="btn btn-default waves-effect waves-light">О Нас</a></li>
                    <li class="nav-item">
                        <a href="${contextPath}/apps" class="light-blue-text"
                           style="display: block; margin-top: 0; text-align: center;">
                ...
                <sec:authorize access="hasRole('ROLE_USER')">
                    ...
                    <%--<li class="nav-item" ${fn:startsWith(requestScope['javax.servlet.forward.request_uri'], '/products') ? 'class="active"' : ''}>--%>
                    <%--<a href="${contextPath}/products" class="btn waves-effect waves-light">Каталог</a></li>--%>
                    <li class="nav-item ${fn:startsWith(requestUri, '/user/company') ? 'active' : ''}">
                        <a href="${contextPath}/user/company" class="btn btn-default waves-effect waves-light">Абонементы
                            компании</a></li>
                    <%--<li class="nav-item" ${fn:startsWith(requestScope['javax.servlet.forward.request_uri'], '/companies') ? 'class="active"' : ''}>--%>
            ...
            <a href="${contextPath}/faq" class="pull-right light-blue-text" style="margin-top: 14px;" title="Часто задаваемые вопросы"><i class="fa fa-question-circle fa-2x"></i></a>
            <a href="${contextPath}/video-help" class="pull-right light-blue-text" style="margin: 14px 10px 0 0;" title="Видео справка"><i class="fa fa-book fa-2x"></i></a>
    ...
    <%--<a href="${contextPath}/company/trainers" class="btn waves-effect waves-light">Тренера</a>--%>
    <%--</li>--%>
    ...
    <%--</li>--%>
    <%--&lt;%&ndash;<li class="dropdown ${fn:startsWith(requestScope['javax.servlet.forward.request_uri'], '/company/info') ? 'active' : ''}">&ndash;%&gt;--%>
    <%--&lt;%&ndash;<a href="${contextPath}/company/info" class="btn dropdown-toggle waves-effect waves-light">Компания <span class="caret"></span></a>&ndash;%&gt;--%>
    <%--&lt;%&ndash;<a href="#" class="btn dropdown-toggle waves-effect waves-light">Компания <span class="caret"></span></a>&ndash;%&gt;--%>
    <%--&lt;%&ndash;<ul class="dropdown-menu" role="menu">&ndash;%&gt;--%>
    <%--&lt;%&ndash;<li><a href="${contextPath}/company/offices">Филиалы</a></li>&ndash;%&gt;--%>
    <%--&lt;%&ndash;<li><a href="${contextPath}/company/directions">Направления</a></li>&ndash;%&gt;--%>
    <%--&lt;%&ndash;<li><a href="${contextPath}/company/groups">Группы</a></li>&ndash;%&gt;--%>
    <%--&lt;%&ndash;<li><a href="${contextPath}/company/employees">Сотрудники</a></li>&ndash;%&gt;--%>
    <%--&lt;%&ndash;</ul>&ndash;%&gt;--%>
    <%--&lt;%&ndash;</li>&ndash;%&gt;--%>
    ...
    <%--<a href="${contextPath}/" class="btn btn-default waves-effect waves-light">Мои абонементы</a>--%>
    <%--</li>--%>
    <%--&lt;%&ndash;<li ${fn:startsWith(requestScope['javax.servlet.forward.request_uri'], '/products') ? 'class="active"' : ''}>&ndash;%&gt;--%>
    <%--&lt;%&ndash;<a href="${contextPath}/products" class="btn waves-effect waves-light">Каталог</a></li>&ndash;%&gt;--%>
    ...
    <%--компании</a></li>--%>
    <%--&lt;%&ndash;<li ${fn:startsWith(requestScope['javax.servlet.forward.request_uri'], '/companies') ? 'class="active"' : ''}>&ndash;%&gt;--%>
    <%--&lt;%&ndash;<a href="${contextPath}/companies" class="btn waves-effect waves-light">О компании</a></li>&ndash;%&gt;--%>
    <%--<li ${requestScope['javax.servlet.forward.request_uri'] == '/about' ? 'class="active"' : ''}>--%>
    <%--<a href="${contextPath}/about" class="btn waves-effect waves-light">О Нас</a></li>--%>
    <%--<li>--%>
    <%--<a href="${contextPath}/apps" class="light-blue-text"--%>
