            ...
            <div class="col-md-12" style="padding-left: 5px;">
                <div class="btn-group lang">
                    <a href="${contextPath}/tariffs" class="btn btn-default light-blue">.руб <img
                            ...
                            alt=""/></a>
                    <a href="#" class="btn btn-default light-blue lighten-2">.руб <img
                            src="${contextPath}/images/features/flag_ru.png"/></a>
                    <a href="${contextPath}/tariffs/usd" class="btn btn-default light-blue">$ <img
            ...
            <div class="col-xs-6 col-sm-4 col-lg-2">
                <div class="card pricing-card">
                    <div class="price header light-blue">
                        ...
                        <h2>1000<i class="fa fa-rub"></i></h2>
                    </div>
                    <div class="card-block striped">
                        <ul>
                            <li>
            ...
            <div class="col-xs-6 col-sm-4 col-lg-2">
                <div class="card pricing-card">
                    <div class="price header light-blue">
                        ...
                        <h2>1300<i class="fa fa-rub"></i></h2>
                    </div>
                    <div class="card-block striped">
                        <ul>
                            <li>
            ...
            <div class="col-xs-6 col-sm-4 col-lg-2">
                <div class="card pricing-card">
                    <div class="price header light-blue">
                        ...
                        <h2>1600<i class="fa fa-rub"></i></h2>
                    </div>
                    <div class="card-block striped">
                        <ul>
                            <li>
            ...
            <div class="col-xs-6 col-sm-4 col-lg-2">
                <div class="card pricing-card">
                    <div class="price header light-blue">
                        ...
                        <h2>2000<i class="fa fa-rub"></i></h2>
                    </div>
                    <div class="card-block striped">
                        <ul>
                            <li>
            ...
            <div class="col-xs-6 col-sm-4 col-lg-2">
                <div class="card pricing-card">
                    <div class="price header light-blue">
                        ...
                        <h2>2300<i class="fa fa-rub"></i></h2>
                    </div>
                    <div class="card-block striped">
                        <ul>
                            <li>
            ...
            <div class="col-xs-6 col-sm-4 col-lg-2">
                <div class="card pricing-card">
                    <div class="price header light-blue">
                        ...
                        <h2>2600<i class="fa fa-rub"></i></h2>
                    </div>
                    <div class="card-block striped">
                        <ul>
                            <li>
            ...
            <div class="col-xs-6 col-sm-4 col-lg-2">
                <div class="card pricing-card">
                    <div class="price header light-blue">
                        ...
                        <h2>3300<i class="fa fa-rub"></i></h2>
                    </div>
                    <div class="card-block striped">
                        <ul>
                            <li>
            ...
            <div class="col-xs-6 col-sm-4 col-lg-2">
                <div class="card pricing-card">
                    <div class="price header light-blue">
                        ...
                        <h2>4500<i class="fa fa-rub"></i></h2>
                    </div>
                    <div class="card-block striped">
                        <ul>
                            <li>
            ...
            <div class="col-xs-6 col-sm-4 col-lg-2">
                <div class="card pricing-card">
                    <div class="price header light-blue">
                        ...
                        <h2>6500<i class="fa fa-rub"></i></h2>
                    </div>
                    <div class="card-block striped">
                        <ul>
                            <li>
