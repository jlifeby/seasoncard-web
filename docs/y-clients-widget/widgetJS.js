...
var yWidget = {
	id: '49600',
	href: 'https://w49600.yclients.com/',
	lang: 'rus',
	isNew: '1',
	...
	clickevent: function() {
		var event = yWidget.mobileAndTabletcheck() ? 'touchstart' : 'click';
		return event;
	},
	addCSS: function() {
		...
		ss.rel = "stylesheet";
		if (yWidget.isNew > 0) {
			ss.href = yWidget.href + "css/ywidget/newweb.css";
		} else {
			ss.href = yWidget.href + "css/ywidget/website.css";
		}
